  ...
  return (
    <div className="w-full h-full flex flex-col min-h-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 xs:gap-3.5 sm:gap-4 md:gap-5 flex-1 min-h-0">
        ...
        <div className="hidden md:flex items-start justify-center" style={{ marginTop: '-10rem', alignSelf: 'flex-start' }}>
          {slide.content.image ? (
            <img
              src={slide.content.image}
              alt={slide.content.imageAlt}
              className="w-full h-auto rounded-xl md:rounded-2xl object-cover max-h-full"
              style={{
