    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center p-3 xs:p-4 sm:p-5 md:p-6 relative overflow-visible">
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto mt-3 xs:mt-4 sm:mt-5 px-2 xs:px-3">
        <div className="relative group">
          ...
          <div 
            className="relative rounded-2xl xs:rounded-3xl p-4 xs:p-5 sm:p-6 md:p-7 text-center cursor-pointer transition-all duration-500 ease-out overflow-hidden"
            style={{
              ...
              boxShadow: 
                '0 12px 40px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -1px 0 rgba(255, 255, 255, 0.08), inset 0 0 30px rgba(0, 146, 70, 0.08)',
              zIndex: 1,
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.border = '1px solid rgba(255, 255, 255, 0.2)';
              e.currentTarget.style.boxShadow = 
                '0 16px 48px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.25), inset 0 -1px 0 rgba(255, 255, 255, 0.12), inset 0 0 40px rgba(0, 146, 70, 0.12)';
          ...
          <div className="relative z-10 space-y-3 xs:space-y-4 sm:space-y-5">
            ...
            <div>
              ...
              <p className="text-xs xs:text-sm sm:text-base md:text-lg font-semibold text-white break-words">
                {slide.content.developer}
              </p>
            </div>

            {/* Divider */}
            <div 
              className="h-px w-full max-w-sm mx-auto"
              style={{
