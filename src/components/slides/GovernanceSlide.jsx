...
export default function GovernanceSlide({ slide, isActive }) {
            ...
            <div className="relative group flex-shrink-0">
              <div 
                ...
                style={{
                  ...
                  boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -1px 0 rgba(255, 255, 255, 0.1), inset 0 0 25px rgba(0, 146, 70, 0.08)',
                  overflow: 'hidden',
                }}
                onMouseEnter={(e) => {
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = 'inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -1px 0 rgba(255, 255, 255, 0.1), inset 0 0 25px rgba(0, 146, 70, 0.08)';
  ...
  const icons = [
    <svg key="government" className="w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: 'white', animation: 'whiteGlow 3s ease-in-out infinite' }}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
    </svg>,
    <svg key="president" className="w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: 'white', animation: 'whiteGlow 3s ease-in-out infinite' }}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
    </svg>,
    <svg key="executive" className="w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: 'white', animation: 'whiteGlow 3s ease-in-out infinite' }}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
    </svg>,
    <svg key="chamber" className="w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: 'white', animation: 'whiteGlow 3s ease-in-out infinite' }}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
    </svg>,
    <svg key="senate" className="w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: 'white', animation: 'whiteGlow 3s ease-in-out infinite' }}>
  ...
  return (
    <div className="w-full h-full flex flex-col min-h-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 xs:gap-3.5 sm:gap-4 md:gap-5 flex-1 min-h-0">
        <div className="flex flex-col gap-2 xs:gap-2.5 sm:gap-3 min-h-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 xs:gap-2.5 sm:gap-3 flex-1 min-h-0">
            {cards.map((card, index) => (
              <div key={index} className={`relative group ${card.fullWidth ? 'col-span-1 sm:col-span-2' : ''}`} style={{ overflow: 'hidden' }}>
                <div 
                  className="relative p-2.5 xs:p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl transition-all duration-700 ease-out h-full flex flex-col"
                  style={{
                    background: 'linear-gradient(135deg, rgba(15, 15, 25, 0.4) 0%, rgba(20, 20, 30, 0.5) 100%)',
                    backdropFilter: 'blur(30px) saturate(200%)',
                    WebkitBackdropFilter: 'blur(30px) saturate(200%)',
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col flex-1">
                    <div className="flex items-center gap-2 xs:gap-3 mb-1.5 sm:mb-2">
                    ...
                    <div className="text-white text-sm xs:text-base sm:text-lg md:text-xl font-semibold break-words leading-relaxed">
                      {card.value}
                    </div>
                    {card.description && (
                      <p className="text-white text-xs xs:text-sm sm:text-base opacity-90 mt-1.5 xs:mt-2 break-words leading-relaxed">
                        {card.description}
                      </p>
                    )}
                  </div>
