  ...
  return (
    <div className="w-full h-full flex flex-col min-h-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1.1fr] gap-1.5 xs:gap-2 sm:gap-2.5 flex-1 min-h-0">
          ...
          <div className="relative group w-full h-full flex items-center justify-center" style={{ isolation: 'isolate', maxWidth: '80%' }}>
            ...
            >
              <img
                ...
                fetchPriority="high"
                onMouseEnter={(e) => {
                  e.currentTarget.parentElement.style.border = '1px solid rgba(255, 255, 255, 0.2)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.parentElement.style.border = '1px solid rgba(255, 255, 255, 0.1)';
                }}
              />
            </div>
          </div>
        ...
        <div className="md:hidden flex items-center justify-center w-full" style={{ maxHeight: '40%' }}>
          <div className="relative group w-full h-full flex items-center justify-center" style={{ isolation: 'isolate', maxWidth: '80%' }}>
            <div 
              className="relative w-full h-full max-w-full max-h-full overflow-hidden"
              style={{ 
