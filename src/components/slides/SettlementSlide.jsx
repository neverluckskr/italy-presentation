  ...
  return (
    <div className="w-full h-full flex flex-col min-h-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 xs:gap-3.5 sm:gap-4 md:gap-5 flex-1 min-h-0">
        ...
        <div className="order-1 md:order-2 hidden md:flex items-center justify-center w-full h-full">
          <div className="relative group w-full flex items-center justify-center" style={{ isolation: 'isolate', maxWidth: '70%' }}>
            <div 
