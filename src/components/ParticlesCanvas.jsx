...
export default function ParticlesCanvas() {
  ...
  // Check if device is low performance - disable particles completely for mobile and low-end devices
  ...
  useEffect(() => {
    // Disable particles for low performance devices
    if (isLowPerformance) {
      return;
    }
  ...
  // Don't render canvas for low performance devices
  if (isLowPerformance) {
    return null;
  }
